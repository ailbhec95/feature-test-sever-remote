 ...
 * @category Configuration
 */
export declare const RemoteEvaluationDefaults: RemoteEvaluationConfig;
/**
 ...
 * @category Configuration
 */
export declare const LocalEvaluationDefaults: LocalEvaluationConfig;
export declare const AssignmentConfigDefaults: Omit<AssignmentConfig, 'apiKey'>;
export declare const CohortSyncConfigDefaults: Omit<CohortSyncConfig, 'apiKey' | 'secretKey'>;
export declare const EU_SERVER_URLS: {
    name: string;
    remote: string;
    flags: string;
    stream: string;
